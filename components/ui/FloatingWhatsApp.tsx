  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="white" className="w-7 h-7">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.112 1.523 5.837L.057 23.082a.75.75 0 00.921.921l5.244-1.466A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.896 0-3.673-.523-5.193-1.432l-.372-.22-3.848 1.076 1.077-3.848-.22-.372A9.945 9.945 0 012 12c0-5.514 4.486-10 10-10s10 4.486 10 10-4.486 10-10 10z" />
      </svg>
    </motion.a>
  )
}
